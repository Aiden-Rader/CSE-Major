...
#include <asm/uaccess.h>  /* Used specifically for copy_to_user() function */
 ...
 */
 ...
 /* Added proc_exit/init to get rid of warnings */
int proc_init(void);
void proc_exit(void);
...
ssize_t proc_read(struct file *file, char __user *usr_buf, size_t count, loff_t *pos)
{
        ...
        // Calculate elapsed seconds since the module was loaded
        unsigned long elapsed_seconds = (jiffies - start_jiffies) / HZ;

        // Format the elapsed time into the buffer
